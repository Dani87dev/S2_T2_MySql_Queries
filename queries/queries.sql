...
SELECT CONCAT(nombre, '   ->   ', precio, 'precio_eur or ', precio, 'precio_usd')
FROM producto;
...
SELECT nombre AS 'nom del producte', precio AS 'euros', FORMAT(precio * 1.1, 2) AS 'dòlars'
FROM producto;
